...
class InputDelete extends StatefulWidget {
  const InputDelete({Key? key}) : super(key: key);

  @override
  State<InputDelete> createState() => _InputDeleteState();
}

class _InputDeleteState extends State<InputDelete> {
